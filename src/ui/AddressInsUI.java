...
public class AddressInsUI extends JFrame implements ActionListener{
	...
	public AddressInsUI(){
		...
		//textaddr.setText(String.valueOf(s.getAd_person()));
		...
		//textaddr.setText(String.valueOf(s.getAd_phone()));
	...
	public void actionPerformed(ActionEvent ac) {
		...
		sf.setAd_uid(BeanUserMsg.currentLoginUser.getUm_id());
