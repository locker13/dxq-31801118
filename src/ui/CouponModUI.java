...
public class CouponModUI extends JFrame implements ActionListener{
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CouponModUI frame = new CouponModUI();
	 ...
	 * Create the frame.
	 */
	public CouponModUI(BeanCoupon s) {
sf.setCp_id(s.getCp_id());
		...
		textEndtime.setText(String.valueOf(s.getCp_eddate()));
