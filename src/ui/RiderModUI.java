...
public class RiderModUI extends JFrame implements ActionListener{
	...
	public RiderModUI(BeanRider s){
		sf.setRd_id(s.getRd_id());
		setTitle("\u4FE1\u606F\u4FEE\u6539");
		...
		textname.setText(s.getRd_name());
		textname.setColumns(10);
		textname.setBounds(84, 45, 125, 21);
		contentPane.add(textname);
		
		textdate = new JTextField();
		textdate.setText(String.valueOf(s.getRd_in()));
		...
		if(s.getRd_status()=="新人")
			radioButton.setSelected(true);
		else if(s.getRd_status()=="正式员工")
